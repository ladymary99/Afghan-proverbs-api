...
import { addProverb } from "../services/api";
...
const AddProverb = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      await addProverb(formData);
      navigate("/", { state: { message: "Proverb added successfully!" } });
    } catch (err) {
      ...
      <div className="proverb-form-container">
        <div className="proverb-form-header">
          ...
          <p className="proverb-form-subtitle">
            Share a traditional Afghan proverb with the community
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="proverb-form">
          ...
          <div className="form-actions">
            ...
            >
              <Save size={18} />
              {submitting ? "Saving..." : "Save Proverb"}
            </button>
          </div>
        </form>
      </div>
